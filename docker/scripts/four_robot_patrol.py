...
Navigates FOUR robots simultaneously in loops through 5 waypoints each:
  ...
  Robot 4 (panther4): BOTTOM_LEFT → TOP_LEFT → MIDDLE → TOP_RIGHT → BOTTOM_RIGHT → BOTTOM_LEFT

Usage:
  python3 four_robot_patrol.py [num_loops] [warmup_secs]
...
def main():
    ...
    # Create all four robot nodes with unique names
