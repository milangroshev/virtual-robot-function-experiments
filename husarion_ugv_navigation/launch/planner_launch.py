...
#
# Nodes: planner_server, smoother_server
# Purpose: Global path planning + path smoothing
#
# CRITICAL FIX: This launch file must perform the SAME ReplaceString substitutions
# as bringup_launch.py before passing params_file to the nodes.
# The shared nav2_params.yaml contains placeholders like <namespace>/, <scan_topic>,
# <stvl_layer>, <min_x>, etc.
...
def generate_launch_description():
    ...
    planner_group = GroupAction(
        [
            ...
            # --- Lifecycle Manager (manages ONLY planner + smoother) ---
            Node(
